                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="flex flex-col gap-1.5">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <input required value={form.phone} onChange={function (e) { setForm(Object.assign({}, form, { phone: e.target.value })); }} maxLength="10" className="bg-dark-800 border border-l-0 border-dark-500/40 text-dark-50 text-xs px-3 py-2.5 rounded-r-lg outline-none focus:border-accent placeholder-dark-300/40" placeholder="9876543210" />
                                    </div>
                                </div>
                                <div className="flex flex-col gap-1.5">
                                    <label className="text-[10px] font-bold text-dark-300 uppercase tracking-wider">Date of Birth</label>
                                    <input type="date" required value={form.dob} onChange={function (e) { setForm(Object.assign({}, form, { dob: e.target.value })); }} max={new Date().toISOString().split('T')[0]} className="bg-dark-800 border border-dark-500/40 text-dark-50 text-xs px-3 py-2.5 rounded-lg outline-none focus:border-accent cursor-pointer" />
                                </div>
                                <div className="flex flex-col gap-1.5">
                                ...
                                <div className="flex flex-col gap-1.5">
                                    <label className="text-[10px] font-bold text-dark-300 uppercase tracking-wider">Current Semester</label>
                                    <select value={form.currentSem} onChange={function (e) { setForm(Object.assign({}, form, { currentSem: e.target.value })); }} className="bg-dark-800 border border-dark-500/40 text-dark-50 text-xs px-3 py-2.5 rounded-lg outline-none focus:border-accent cursor-pointer">
                                        {[1, 2, 3, 4, 5, 6, 7, 8].map(function (n) { return <option key={n} value={n}>Semester {n}</option>; })}
                                    </select>
                                </div>
                                <div className="flex flex-col gap-1.5">
                                    <label className="text-[10px] font-bold text-dark-300 uppercase tracking-wider">CGPA</label>
                                    <input type="number" min="0" max="10" step="0.01" value={form.cgpa} onChange={function (e) { setForm(Object.assign({}, form, { cgpa: e.target.value })); }} className="bg-dark-800 border border-dark-500/40 text-dark-50 text-xs px-3 py-2.5 rounded-lg outline-none focus:border-accent focus:ring-1 focus:ring-accent/20 placeholder-dark-300/40" placeholder="8.50" />
                                </div>
                                <div className="flex flex-col gap-1.5">
                                ...
                                <div className="flex flex-col gap-1.5">
                                    ...
                                    <input type="number" min="0" value={form.feeAmount} onChange={function (e) { setForm(Object.assign({}, form, { feeAmount: e.target.value })); }} className="bg-dark-800 border border-dark-500/40 text-dark-50 text-xs px-3 py-2.5 rounded-lg outline-none focus:border-accent placeholder-dark-300/40" placeholder="25000" />
                                </div>
                                <div className="flex flex-col gap-1.5">
                                ...
                                <div className="flex flex-col gap-1.5 col-span-2">
                                    ...
                                    <textarea value={form.address} onChange={function (e) { setForm(Object.assign({}, form, { address: e.target.value })); }} rows="2" className="bg-dark-800 border border-dark-500/40 text-dark-50 text-xs px-3 py-2.5 rounded-lg outline-none focus:border-accent resize-y placeholder-dark-300/40" placeholder="Hostel Block A, Room 204"></textarea>
                                </div>
                            </div>
                    ...
                    <div className="bg-dark-700 border border-dark-500/30 rounded-xl w-full max-w-md shadow-2xl" onClick={function (e) { e.stopPropagation(); }}>
                        ...
                        <div className="p-6">
                            ...
                            <div className="grid grid-cols-2 gap-3 text-xs">
                                ...
                                <div><div className="text-[10px] text-dark-300 uppercase tracking-wider">Enrolled</div><div className="font-medium mt-0.5">{showProfile.enrollDate ? formatDate(showProfile.enrollDate) : 'N/A'}</div></div>
